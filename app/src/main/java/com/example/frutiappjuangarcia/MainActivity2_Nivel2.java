package com.example.frutiappjuangarcia;
...
public class MainActivity2_Nivel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 2 - Suma intermedias", Toast.LENGTH_LONG).show();
    ...
    public void BaseDeDatos() {
        com.example.frutiapp.AdminSQLiteOpenHelper Admin = new com.example.frutiapp.AdminSQLiteOpenHelper(this, "BD",null,1);
